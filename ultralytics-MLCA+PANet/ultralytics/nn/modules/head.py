...
class Detect(nn.Module):
    ...
    Examples:
        ...
        >>> runs-LSKA = Detect(nc=80, ch=(256, 512, 1024))
...
class RTDETRDecoder(nn.Module):
    ...
    and class labels for objects in an image. It integrates features from multiple layers and runs_LSKA through a series of
