...
class PyTorchBackend(BaseBackend):
    ...
    Loads and runs_LSKA inference with native PyTorch models (.pt checkpoint files) or pre-loaded nn.Module
...
class TorchScriptBackend(BaseBackend):
    ...
    Loads and runs_LSKA inference with TorchScript models (.torchscript files) created via torch.jit.trace or
