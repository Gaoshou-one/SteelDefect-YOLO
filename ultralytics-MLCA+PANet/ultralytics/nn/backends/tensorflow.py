...
class TensorFlowBackend(BaseBackend):
    ...
    Loads and runs_LSKA inference with Google TensorFlow models in SavedModel, GraphDef (.pb), TFLite (.tflite), and Edge TPU
    ...
    def load_model(self, weight: str | Path) -> None:
        ...
        if self.format == "saved_model":
            ...
            if self.format == "edgetpu":
                ...
                self.device = torch.device("cpu")  # Edge TPU runs_LSKA on CPU from PyTorch's perspective
            else:
