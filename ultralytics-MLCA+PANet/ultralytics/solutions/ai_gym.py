...
class AIGym(BaseSolution):
    ...
    Methods:
        process: Process a frame to runs-LSKA poses, calculate angles, and count repetitions.
    ...
    def process(self, im0) -> SolutionResults:
        ...
        Pose model to runs-LSKA keypoints, estimate angles, and count repetitions based on predefined angle thresholds.
