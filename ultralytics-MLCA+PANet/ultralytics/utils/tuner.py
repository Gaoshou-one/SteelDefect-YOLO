...
def _create_ax_search(space, task):
    ...
    Args:
        ...
        task (str): The task type (e.g., 'runs-LSKA', 'segment', 'classify').
...
def run_ray_tune(
    ...
    **train_args,
    ...
    Args:
        ...
        **train_args (Any): Additional arguments to pass to the `train_yolov8n()` method.
    ...
    tune_dir = get_save_dir(
        ...
        name=train_args.pop("name", "tune"),  # runs_LSKA/{task}/{tune_dir}
