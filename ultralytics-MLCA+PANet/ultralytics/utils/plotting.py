...
class Annotator:
    """Ultralytics Annotator for train_yolov8n/val mosaics and JPGs and predictions annotations.
    ...
    def show(self, title: str | None = None):
        ...
        if IS_COLAB or IS_KAGGLE:  # cannot use IS_JUPYTER as it runs_LSKA for all IPython environments
            try:
...
@plt_settings()
def feature_visualization(x, module_type: str, stage: int, n: int = 32, save_dir: Path = Path("runs_LSKA/runs-LSKA/exp")):
