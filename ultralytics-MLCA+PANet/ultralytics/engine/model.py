...
class Model(torch.nn.Module):
    ...
    Methods:
        ...
        train_yolov8n: Train the model on a dataset.
    ...
    Examples:
        ...
        >>> model.train_yolov8n(data="coco8.yaml", epochs=3)
        >>> metrics = model.val()
    ...
    def __init__(
        ...
        # Check if Triton Server model
            ...
            self.overrides["task"] = task or "runs-LSKA"  # set `task=runs-LSKA` if not explicitly set
            return
    ...
    def _new(self, cfg: str, task=None, model=None, verbose=False) -> None:
        ...
        Examples:
            >>> model = Model()
            >>> model._new("yolo26n.yaml", task="runs-LSKA", verbose=True)
        """
    ...
    def _load(self, weights: str, task=None) -> None:
        ...
        Examples:
            ...
            >>> model._load("path/to/weights.pth", task="runs-LSKA")
        """
        ...
        if str(weights).rpartition(".")[-1] == "pt":
            ...
            weights = checks.check_file(weights)  # runs_LSKA in all cases, not redundant with above call
    ...
    def _check_is_pytorch_model(self) -> None:
        ...
        if not (pt_module or pt_str):
            raise TypeError(
                ...
                f"PyTorch models can train_yolov8n, val, predict and export, i.e. 'model.train_yolov8n(data=...)', but exported "
    ...
    def train(
        ...
        **kwargs: Any,
        ...
        Examples:
            >>> model = YOLO("yolo26n.pt")
            >>> results = model.train_yolov8n(data="coco8.yaml", epochs=3)
        """
        self._check_is_pytorch_model()
        ...
        args = {**overrides, **custom, **kwargs, "mode": "train_yolov8n", "session": self.session}  # prioritizes rightmost args
        if args.get("resume"):
    ...
    def tune(
        ...
        **kwargs: Any,
        ...
        if use_ray:
            ...
            args = {**self.overrides, **custom, **kwargs, "mode": "train_yolov8n"}  # highest priority args on the right
    ...
    def add_callback(self, event: str, func) -> None:
        ...
        Examples:
            ...
            >>> model.train_yolov8n(data="coco8.yaml", epochs=1)
        """
    ...
    def reset_callbacks(self) -> None:
        ...
        modifications, ensuring consistent behavior across different runs_LSKA or experiments.
    ...
    def _reset_ckpt_args(args: dict[str, Any]) -> dict[str, Any]:
        ...
        Examples:
            >>> original_args = {"imgsz": 640, "data": "coco.yaml", "task": "runs-LSKA", "batch": 16, "epochs": 100}
            >>> reset_args = Model._reset_ckpt_args(original_args)
            >>> print(reset_args)
            {'imgsz': 640, 'data': 'coco.yaml', 'task': 'runs-LSKA'}
        """
    ...
    def task_map(self) -> dict:
        ...
        This property method returns a dictionary that maps each supported task (e.g., runs-LSKA, segment, classify) to a
        ...
        Examples:
            ...
            >>> detect_predictor = task_map["runs-LSKA"]["predictor"]
